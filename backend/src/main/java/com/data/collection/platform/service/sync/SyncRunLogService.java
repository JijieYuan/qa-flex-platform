...
public class SyncRunLogService {
  ...
  private Map<String, Object> toLogRow(SyncRun run) {
    ...
    row.put("tableCount", run.getPlannedTableCount() == null ? 0 : run.getPlannedTableCount());
    row.put("completedTableCount", run.getCompletedTableCount() == null ? 0 : run.getCompletedTableCount());
